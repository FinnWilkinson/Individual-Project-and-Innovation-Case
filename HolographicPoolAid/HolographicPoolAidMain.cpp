#include "pch.h"
#include "HolographicPoolAidMain.h"
#include "Common/DirectXHelper.h"

#include <windows.graphics.directx.direct3d11.interop.h>

using namespace HolographicPoolAid;
...
HolographicPoolAidMain::HolographicPoolAidMain(std::shared_ptr<DX::DeviceResources> const& deviceResources) :
    m_deviceResources(deviceResources)
{
    ...
    m_gamepadAddedEventToken = Gamepad::GamepadAdded(bind(&HolographicPoolAidMain::OnGamepadAdded, this, _1, _2));
    m_gamepadRemovedEventToken = Gamepad::GamepadRemoved(bind(&HolographicPoolAidMain::OnGamepadRemoved, this, _1, _2));
    ...
    if (m_canGetDefaultHolographicDisplay)
    {
        ...
        m_holographicDisplayIsAvailableChangedEventToken = HolographicSpace::IsAvailableChanged(bind(&HolographicPoolAidMain::OnHolographicDisplayIsAvailableChanged, this, _1, _2));
    }
...
void HolographicPoolAidMain::SetHolographicSpace(HolographicSpace const& holographicSpace)
{
    ...
    m_cameraAddedToken = m_holographicSpace.CameraAdded(std::bind(&HolographicPoolAidMain::OnCameraAdded, this, _1, _2));
    ...
    m_cameraRemovedToken = m_holographicSpace.CameraRemoved(std::bind(&HolographicPoolAidMain::OnCameraRemoved, this, _1, _2));
...
void HolographicPoolAidMain::UnregisterHolographicEventHandlers()
{
...
HolographicPoolAidMain::~HolographicPoolAidMain()
{
...
HolographicFrame HolographicPoolAidMain::Update(HolographicFrame const& previousFrame)
{
...
bool HolographicPoolAidMain::Render(HolographicFrame const& holographicFrame)
{
...
void HolographicPoolAidMain::SaveAppState()
{
    //
...
void HolographicPoolAidMain::LoadAppState()
{
    //
...
void HolographicPoolAidMain::OnPointerPressed()
{
    m_pointerPressed = true;
}
...
void HolographicPoolAidMain::OnDeviceLost()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void HolographicPoolAidMain::OnDeviceRestored()
{
#ifdef DRAW_SAMPLE_CONTENT
...
void HolographicPoolAidMain::OnLocatabilityChanged(SpatialLocator const& sender, winrt::Windows::Foundation::IInspectable const& args)
{
...
void HolographicPoolAidMain::OnCameraAdded(
...
void HolographicPoolAidMain::OnCameraRemoved(
    HolographicSpace const& sender,
...
void HolographicPoolAidMain::OnGamepadAdded(winrt::Windows::Foundation::IInspectable, Gamepad const& args)
{
...
void HolographicPoolAidMain::OnGamepadRemoved(winrt::Windows::Foundation::IInspectable, Gamepad const& args)
{
...
void HolographicPoolAidMain::OnHolographicDisplayIsAvailableChanged(winrt::Windows::Foundation::IInspectable, winrt::Windows::Foundation::IInspectable)
{
    ...
    if (m_spatialLocator != spatialLocator)
    {
        ...
        if (spatialLocator != nullptr)
        {
            ...
            m_locatabilityChangedToken = m_spatialLocator.LocatabilityChanged(std::bind(&HolographicPoolAidMain::OnLocatabilityChanged, this, _1, _2));
