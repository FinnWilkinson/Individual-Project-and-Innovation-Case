...
namespace HolographicPoolAid
{
    class HolographicPoolAidMain : public DX::IDeviceNotify
    {
    public:
        HolographicPoolAidMain(std::shared_ptr<DX::DeviceResources> const& deviceResources);
        ~HolographicPoolAidMain();
